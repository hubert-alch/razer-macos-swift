...
也可以在 GitHub Actions 內用 workflow dispatch，輸入 `version=0.4.17`。workflow 會執行 Swift 測試、簽名原生 app 與 disk image、提交 Apple 公證、staple app 與 disk image、上傳建置 artifacts，並發佈 GitHub Release assets。
