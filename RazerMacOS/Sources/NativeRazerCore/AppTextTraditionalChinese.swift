extension AppText {
  static let traditionalChinese: [AppStringKey: String] = [
    ...
    .controllerLedNextPattern: "切換 LED 模式",
    .controllerLight: "手掣燈光",
    .controllerPressToTest: "按下手掣按鍵或移動搖桿，下方數值會即時變化。",
    .controllerProtocolXbox360: "Xbox 360 協議",
    .controllerProtocolXboxOneGip: "Xbox One GIP 協議",
    .controllerSourceXInputDirect: "XInput 直讀",
    ...
    .controllerXInputNoInput: "接收器已連接，但手掣沒有輸入，手掣可能未開機。",
