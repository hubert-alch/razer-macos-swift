extension AppText {
  static let english: [AppStringKey: String] = [
    ...
    .controllerLedNextPattern: "Next LED Pattern",
    ...
    .controllerProtocolXbox360: "Xbox 360 protocol",
    .controllerProtocolXboxOneGip: "Xbox One GIP protocol",
    .controllerSourceXInputDirect: "XInput direct",
    ...
    .controllerXInputNoInput: "The receiver is connected, but no controller input is arriving. The controller may be powered off.",
