...
也可以在 GitHub Actions 里用 workflow dispatch，输入 `version=0.4.16`。workflow 会运行 Swift 测试、签名原生 app 与 disk image、提交 Apple 公证、staple app 与 disk image、上传构建 artifacts，并发布 GitHub Release assets。
